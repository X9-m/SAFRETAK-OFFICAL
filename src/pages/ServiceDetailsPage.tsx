    ...
    <div className="details-page page-enter">
      ...
      <section className="details-hero rich-details-hero">
        ...
        <div className="details-copy">
          <div className="details-title-actions"><span className="eyebrow">{meta.label}</span><button type="button" className={`favorite-button inline ${favorite ? 'active' : ''}`} onClick={() => onFavorite(service, !favorite)} aria-label={favorite ? 'إزالة من المفضلة' : 'إضافة إلى المفضلة'}><Heart size={18} fill={favorite ? 'currentColor' : 'none'} /></button></div>
